...
- The prefill is configurable with =visual-regexp-rx-prefill-form=
  (string, default ="(seq "")"=): the form prefilled in the regexp
  minibuffer.  Set it to =""= to disable the prefill and start with an
  empty minibuffer, or to any other one-line rx form to prefill
  something else.  Point ends up inside the first =""= of the form, or
...
- A =minibuffer-setup-hook= prefills =visual-regexp-rx-prefill-form=
  ...
  and replaced by a never-matching regexp.
